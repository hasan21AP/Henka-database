...
# 🔹 المسار المحلي للصور
folder_path = r"G:\Visual_Studio_Work_Place\Python Projects\perfumes"

# 🔹 بيانات Firebase
bucket = "henka-game.firebasestorage.app"
firebase_folder = "perfumes"

# 🔹 التوكن
token = "7590ae50-096c-4944-afaa-f9dc1a381c85"
...
df.to_excel("perfumes_questions.xlsx", index=False)
