...
# 🔹 المسار المحلي
folder_path = r"G:\Visual_Studio_Work_Place\Python Projects\downloads\Anime Best Moments"

# 🔹 بيانات Firebase
bucket = "henka-game.firebasestorage.app"
firebase_folder = "anime_moments"

# ⚠️ نفس التوكن (لو كلهن نفس الشيء)
token = "57a73e2b-a50a-4b2d-a436-3f3d257fa136"
...
# حذف الرقم + المسافة + الشرطة من البداية
        ...
        rows.append({
            "السؤال": "خمن الأنمي مع ذكر الحدث؟!",
            "الإجابة": answer,
            "الميديا": url,
            "النقاط": 300
        })
...
df.to_excel("anime_moments_questions.xlsx", index=False)
